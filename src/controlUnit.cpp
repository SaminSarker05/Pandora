...
ControlUnit::ControlUnit(ArithmeticLogicUnit& alu, std::vector<Register>& registers) : alu(alu), registers(registers) {
  program_counter.set(0);
}

// fetch program instructions from memory
void ControlUnit::fetch_memory(std::vector<int>& program) { 
...
void ControlUnit::decode(int instructions) {
